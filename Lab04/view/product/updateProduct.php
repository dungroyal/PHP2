...
<form action="index.php?ctrller=products&act=edit" method="post" class="form-horizontal" enctype="multipart/form-data">
    <fieldset>

    <?php
        echo'index.php?ctrller=products&act=edit&idProduct='.$idPro;
    ?>

        <!-- Form Name -->
        <legend style="font-size:50px;margin:50px 0px;">
            <center>Sửa sản phẩm</center>
        </legend>
        ...
        <!-- Button -->
        <div class="form-group">
            <label class="col-md-4 control-label" for="singlebutton">Sửa sản phẩm</label>
            <div class="col-md-4">
                <input type="submit" value="Lưu thây đổi" name="updatePro" class="btn btn-primary">
