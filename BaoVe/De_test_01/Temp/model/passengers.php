<?php
    ...
    class PASSENGER extends DATABASE
    {
        ...
        {
            $this->SetQuery("SELECT passengers.id,name,origin,destination,duration FROM passengers,flights where passengers.flight_id = flights.id ORDER BY `passengers`.`id` DESC");
